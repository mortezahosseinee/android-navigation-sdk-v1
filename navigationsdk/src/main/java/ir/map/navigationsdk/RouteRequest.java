...
import ir.map.navigationsdk.model.base.BaseModel;
import ir.map.navigationsdk.model.enums.RouteOverView;
import ir.map.navigationsdk.model.enums.RoutePlan;
import ir.map.navigationsdk.model.enums.RouteType;
import ir.map.navigationsdk.model.inner.Coordinate;

import static ir.map.navigationsdk.model.enums.RouteType.DRIVING;
